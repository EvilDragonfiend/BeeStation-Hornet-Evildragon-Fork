...
/datum/plant_gene/trait/poffu/on_grow(obj/machinery/hydroponics/H)
	...
	var/datum/reagents/temp_reag_container = new(initial(plant.volume))
	...
	var/datum/effect_system/smoke_spread/chem/smoke_machine/smoke_effect = new
