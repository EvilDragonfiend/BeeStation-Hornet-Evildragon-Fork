		...
		if(part.aperture_angle)
			...
			switch(state)
				...
				if(AIRLOCK_CLOSING)
					part.pixel_w = part.open_px
					part.pixel_z = part.open_py
					animate(part, pixel_w = part.open_px, pixel_z = part.open_py, time = open_speed - part.move_end_time)
					animate(pixel_w = 0, pixel_z = 0, time = part.move_end_time - part.move_start_time)
				if(AIRLOCK_OPENING)
					part.pixel_w = 0
					part.pixel_z = 0
					animate(part, pixel_w = 0, pixel_z = 0, time = part.move_start_time)
					animate(pixel_w = part.open_px, pixel_z = part.open_py, time = part.move_end_time - part.move_start_time)
